 ...
 * of options would be better served by using {@link APKSelectDialog} and
 * {@link ChoiceDialog}, respectively.
 *
 * <p>When creating an Alert instance, users must pass in an {@link Alert.AlertType}
...
public class Alert extends Dialog<ButtonType> {
    ...
    /**
     * Creates an alert with the given AlertType (refer to the {@link Alert.AlertType}
    ...
    public Alert(@NamedArg("alertType") Alert.AlertType alertType,
        ...
        stylesheets.addAll(Alert.class.getResource("/css/dialog.css").toExternalForm());
    ...
    /**
     * When creating an Alert instance, users must pass in an {@link Alert.AlertType}
     * enumeration value. It is by passing in this value that the Alert instance will
     * configure itself appropriately (by setting default values for many of the
     * {@link Dialog} properties, including {@link #titleProperty() title},
     * {@link #headerTextProperty() header}, and {@link #graphicProperty() graphic},
...
//            Node newGraphic = null;
            ...
            switch (getAlertType()) {
                ...
                case INFORMATION: {
                    ...
                    stage.getIcons().add(new Image("/drawable/ic_information_title.png"));
                    break;
                }
                case WARNING: {
                    ...
                    styleClass = "warning";
                    stage.getIcons().add(new Image("/drawable/ic_warning_title.png"));
                    break;
                }
                case ERROR: {
                    newTitle = ControlResources.getString("Dialog.error.title");
                    newHeader = ControlResources.getString("Dialog.error.header");
                    stage.getIcons().add(new Image("/drawable/ic_error_title.png"));
                    styleClass = "error";
                    break;
                }
                case CONFIRMATION: {
     ...
     * {@link ButtonType#ButtonType(String, ButtonBar.ButtonData)}
     * constructors.
     *
