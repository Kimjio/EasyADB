 ...
 * the two pre-built dialogs ({@link APKSelectDialog} and {@link ChoiceDialog}),
 ...
 *       <ol>
 *           <li>The button has a {@link ButtonType} whose {@link ButtonBar.ButtonData} is of type
 *           {@link ButtonBar.ButtonData#CANCEL_CLOSE}.</li>
 *           <li>The button has a {@link ButtonType} whose {@link ButtonBar.ButtonData} returns true
 *           when {@link ButtonBar.ButtonData#isCancelButton()} is called.</li>
 *       </ol>
 *     </ol>
...
public class Dialog<R> implements EventTarget {
     ...
     * clicked on into a value of type R. Refer to the {@link javafx.scene.control.Dialog} class
